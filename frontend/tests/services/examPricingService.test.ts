...
import {
    ...
    calculateClassCost
} from '../../services/examPricingService';
...
describe('Exam Pricing Service', () => {
    ...
    describe('calculateClassCost', () => {
        const mockInventory: Item[] = [
            { id: 'paper-1', name: 'A4 Paper', sku: 'A4-PAPER', type: 'Stationery', cost: 10, price: 15, category: 'Paper', stock: 100 },
            { id: 'toner-1', name: 'Black Toner', sku: 'BLK-TONER', type: 'Stationery', cost: 100, price: 150, category: 'Toner', stock: 10 }
        ];
