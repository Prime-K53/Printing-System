            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <button
                ...
                style={{
                  ...
                  background: selected.size > 0 ? '#E2E8F0' : 'transparent',
                  color: selected.size > 0 ? '#0F2C59' : '#6b7280',
                  cursor: 'pointer',
                  lineHeight: 1.4,
                  fontFamily: F,
                }}
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          padding: '12px 14px',
                          marginBottom: 10,
                          border: isSelected ? '2px solid #059669' : '1px solid #E9EDF3',
                          display: 'flex',
                          alignItems: 'center',
                          gap: 12,
                      ...
                      >
                        <button
                          ...
                          style={{
                            ...
                            cursor: 'pointer',
                            color: isSelected ? '#0F2C59' : '#6b7280',
                            display: 'flex',
                            alignItems: 'center',
